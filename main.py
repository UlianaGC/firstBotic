...
bot = telebot.TeleBot("5940821102:AAHFOK3KnRKUiLeVKNWbjvgvdTV_c0EjZZE", parse_mode=None)
news_key='7fc87e5f3fa24b92a9246307d71773ea'
...
def send_welcome(message):
    ...
    if not user:
        ...
        connect.commit()
        bot.reply_to(message, "Вы успешно зарегались",reply_markup=markup)
    else:
        bot.reply_to(message, "Вы уже зареганы",reply_markup=markup)
